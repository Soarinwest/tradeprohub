...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='tradeprohub_db_devel'),
...
AUTHENTICATION_BACKENDS = [
    'users.views.EmailBackend',  # Our custom email backend
...
# DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@tradepro-hub.com')
